...
/// Creates a Bork polygon emitter and returns an emitter index. This emitter index can be used to
...
function BorkPolygon(_radius, _pointArray, _x = 0, _y = 0)
{
    ...
    return (new __BorkClassPolygon(_radius, _pointArray, _x, _y)).__gmEmitter;
}
